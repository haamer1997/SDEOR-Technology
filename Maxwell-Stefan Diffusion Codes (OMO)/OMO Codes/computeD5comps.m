function D = computeD5comps(D12xP,D13xP,D14xP,D15xP,D23xP,D24xP,D25xP,D34xP,D35xP,D45xP,pG,n_cMinus1,TinK,Pci,Tci, ...
...
%   Detailed explanation goes here
    ...
    B(1,1) = zi(1)/D15xP + zi(2)/D12xP + zi(3)/D13xP + zi(4)/D14xP + zi(5)/D15xP; % pg 87
    B(1,2) = -zi(1)*(1.0/D12xP - 1.0/D15xP);
    B(1,3) = -zi(1)*(1.0/D13xP - 1.0/D15xP);
    B(1,4) = -zi(1)*(1.0/D14xP - 1.0/D15xP);
    B(2,1) = -zi(2)*(1.0/D12xP - 1.0/D25xP);
    B(2,2) = zi(1)/D12xP + zi(2)/D25xP + zi(3)/D23xP + zi(4)/D24xP + zi(5)/D25xP;
    B(2,3) = -zi(2)*(1.0/D23xP - 1.0/D25xP);
    B(2,4) = -zi(2)*(1.0/D24xP - 1.0/D25xP);
    B(3,1) = -zi(3)*(1.0/D13xP - 1.0/D35xP);
    B(3,2) = -zi(3)*(1.0/D23xP - 1.0/D35xP);
    B(3,3) = zi(1)/D13xP + zi(2)/D23xP + zi(3)/D35xP + zi(4)/D34xP + zi(5)/D35xP;
    B(3,4) = -zi(3)*(1.0/D34xP - 1.0/D35xP);
    B(4,1) = -zi(4)*(1.0/D14xP - 1.0/D45xP);
    B(4,2) = -zi(4)*(1.0/D24xP - 1.0/D45xP);
    B(4,3) = -zi(4)*(1.0/D34xP - 1.0/D45xP);
    B(4,4) = zi(1)/D14xP + zi(2)/D24xP + zi(3)/D34xP + zi(4)/D45xP + zi(5)/D45xP;
