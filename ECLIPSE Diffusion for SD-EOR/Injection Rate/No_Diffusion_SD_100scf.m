...
G_matrix.rock=makeShaleRock(G_matrix,1*nano*darcy,0.07); %20*micro*darcy
...
% pwf = 2500*psia;
% pinj = 3000*psia;
rate = 0.00003277; %10,000 scf/day = 0.003277 m^3/s
...
if ~opt.shouldPlot
    ...
    fullFinalOut = [fpath, 'No_Diffusion_SD_100scf.mat'];
