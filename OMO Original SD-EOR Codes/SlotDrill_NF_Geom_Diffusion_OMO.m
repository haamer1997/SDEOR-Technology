...
G_matrix = tensorGrid(0:30:physdim(1), 0:20:physdim(2),z);
G_matrix = computeGeometry(G_matrix);    
G_matrix.rock=makeShaleRock(G_matrix,20*micro*darcy,0.07); %20*micro*darcy
...
G_matrix.rock.perm(fraccells) = 5*darcy; %5*darcy
...
set1 = Field(DFN('dim',3,'n',10,'dir',0,'ddir',0,'minl',0.3,...
