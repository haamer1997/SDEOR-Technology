...
if isempty(opt.trans)
   %Hassan Edit: Compute Tdiff
   if G.rock.shaleMechanisms.Diffusion
        [N, T, T_all,Tdiff_gas,Tdiff_gas_all,Tdiff_oil,Tdiff_oil_all, intInx] = grid_based_trans_diffusion(G, rock, opt);
   else
...
if G.rock.shaleMechanisms.Diffusion
    op = struct('T' , T,                   'T_all',        T_all,  ...
                'Tdiff_gas',Tdiff_gas,     'Tdiff_gas_all',Tdiff_gas_all,...
                'Tdiff_oil',Tdiff_oil,     'Tdiff_oil_all',Tdiff_oil_all,...
...
%--------------------------------------------------------------------------
%Hassan Edit: compute Tdiff
function [N, T, T_all,Tdiff_gas,Tdiff_gas_all,Tdiff_oil,Tdiff_oil_all, intInx] = grid_based_trans_diffusion(G, rock, opt)
   ...
   Tdiff_gas_all = Tdiff_gas;
   Tdiff_gas = Tdiff_gas(intInx,:);
   
   Tdiff_oil_all = Tdiff_oil;
