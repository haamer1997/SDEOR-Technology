function G = assembleShaleGlobalGrid(Gm)
...
for i = 1:numel(fieldnames(G.FracGrid))
    ...
    %Hassan Edit: append G_Global with gas and oil diffusion coeff. in matrix and fracture cells
    if G.rock.shaleMechanisms.Diffusion
        G.rock.Dg = [G.rock.Dg;Gf.rock.Dg]; 
        G.rock.Do = [G.rock.Do;Gf.rock.Do];
    end
