...
fracplanes(4).points=[1.4,0,0; 1.4,1,0; 2,1,0.6; 2,0,0.6];
fracplanes(5).points=[1,0,0.4; 1,1,0.4; 1.6,1,1; 1.6,0,1];
fracplanes(6).points=[1.6,0,0; 1.6,1,0; 2,1,0.4; 2,0,0.4];
fracplanes(7).points=[1,0,0.6; 1,1,0.599; 1.4,1,1; 1.4,0,1];
