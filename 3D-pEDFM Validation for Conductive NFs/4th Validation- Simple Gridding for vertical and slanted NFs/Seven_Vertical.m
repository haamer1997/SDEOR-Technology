...
fracplanes = struct;
fracplanes(1).points=[1.5,0.25,0.25; 1.5,0.75,0.25; 1.5,0.75,.75; 1.5,0.25,0.75];
fracplanes(2).points=[1.7,0.25,0.25; 1.7,0.75,0.25; 1.7,0.75,.75; 1.7,0.25,0.75];
fracplanes(3).points=[1.3,0.25,0.25; 1.3,0.75,0.25; 1.3,0.75,.75; 1.3,0.25,0.75];
fracplanes(4).points=[1.9,0.25,0.25; 1.9,0.75,0.25; 1.9,0.75,.75; 1.9,0.25,0.75];
fracplanes(5).points=[1.1,0.25,0.25; 1.1,0.75,0.25; 1.1,0.75,.75; 1.1,0.25,0.75];
fracplanes(6).points=[1.01,0.25,0.25; 1.01,0.75,0.25; 1.01,0.75,.75; 1.01,0.25,0.75];
fracplanes(7).points=[1.99,0.25,0.25; 1.99,0.75,0.25; 1.99,0.75,.75; 1.99,0.25,0.75];
