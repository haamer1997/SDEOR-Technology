...
fracplanes = struct;
fracplanes(1).points=[3,2,0; 3,7,0; 5,7,3; 5,2,3];
fracplanes(2).points=[3.05,2,0; 3.05,7,0; 5.05,7,3; 5.05,2,3];
fracplanes(3).points=[3.1,2,0; 3.1,7,0; 5.1,7,3; 5.1,2,3];
fracplanes(4).points=[3.15,2,0; 3.15,7,0; 5.15,7,3; 5.15,2,3];
fracplanes(5).points=[3.2,2,0; 3.2,7,0; 5.2,7,3; 5.2,2,3];
fracplanes(6).points=[3.25,2,0; 3.25,7,0; 5.25,7,3; 5.25,2,3];
fracplanes(7).points=[3.3,2,0; 3.3,7,0; 5.3,7,3; 5.3,2,3];
