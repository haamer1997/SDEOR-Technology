...
fracplanes(4).points=[2,4.4,0; 7,4.4,0; 7,4.4,3; 2,4.4,3];
fracplanes(5).points=[2,4.5,0; 7,4.5,0; 7,4.5,3; 2,4.5,3];
fracplanes(6).points=[2,4.6,0; 7,4.6,0; 7,4.6,3; 2,4.6,3];
