...
fracplanes = struct;
fracplanes(1).points=[2,4.5,0; 7,4.5,0; 7,4.5,3; 2,4.5,3];
fracplanes(2).points=[4.5,2,0; 4.5,7,0; 4.5,7,3; 4.5,2,3];
fracplanes(3).points=[2,4.6,0; 7,4.6,0; 7,4.6,3; 2,4.6,3];
fracplanes(4).points=[4.6,2,0; 4.6,7,0; 4.6,7,3; 4.6,2,3];
