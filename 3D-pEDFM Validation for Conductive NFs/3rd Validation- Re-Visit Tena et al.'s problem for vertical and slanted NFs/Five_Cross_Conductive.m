...
fracplanes = struct;
fracplanes(1).points=[4.5,2,0; 4.5,7,0; 4.5,7,3; 4.5,2,3];
fracplanes(2).points=[4.4,2,0; 4.4,7,0; 4.4,7,3; 4.4,2,3];
fracplanes(3).points=[4.6,2,0; 4.6,7,0; 4.6,7,3; 4.6,2,3];
fracplanes(4).points=[4.45,2,0; 4.45,7,0; 4.45,7,3; 4.45,2,3];
fracplanes(5).points=[4.55,2,0; 4.55,7,0; 4.55,7,3; 4.55,2,3];

fracplanes(6).points=[2,4.4,0; 7,4.4,0; 7,4.4,3; 2,4.4,3];
fracplanes(7).points=[2,4.5,0; 7,4.5,0; 7,4.5,3; 2,4.5,3];
fracplanes(8).points=[2,4.6,0; 7,4.6,0; 7,4.6,3; 2,4.6,3];
fracplanes(9).points=[2,4.45,0; 7,4.45,0; 7,4.45,3; 2,4.45,3];
fracplanes(10).points=[2,4.55,0; 7,4.55,0; 7,4.55,3; 2,4.55,3];
