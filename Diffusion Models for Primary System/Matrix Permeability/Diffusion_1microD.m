...
%Rock Properties
matrix_perm = 1*micro*darcy; %100*micro
matrix_poro= 0.09;
%HF Properties
frac_poro = 0.5;
...
[ws_ECL, states_ECL, reports_ECL] = simulateScheduleAD(state_ECL, modelDiagonalAD_ECL, schedule, 'nonlinearsolver', nls,'Verbose', true);
%% plotting
if (opt.shouldPlot)
...
if ~opt.shouldPlot
    ...
    fullFinalOut = [fpath, 'Diffusion_1microD.mat'];
