...
% tol4domain = tol*1e3;
% 
% set1 = Field(DFN('dim',3,'n',400,'dir',100,'ddir',-100,'minl',5,...
...
%            'shape','s'),'Poly'); 
% set2 = Field(DFN('dim',3,'n',400,'dir',45,'ddir',-100,'minl',5,...
...
%             'shape','s'),'Poly');  
% set3 = Field(DFN('dim',3,'n',200,'dir',-55,'ddir',-100,'minl',5,...
...
if ~opt.shouldPlot
    ...
    fullFinalOut = [fpath, 'Bakken_MSHF_Pwf_1800psia_8years.mat'];
