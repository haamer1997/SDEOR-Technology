...
rate = 18e-8; % 0.1 bbl/d = 18e-8 m3/s
...
case 'ProdTop_InjBot'
    ...
    W = verticalWell(W, G, G.rock, 20, 10, frac_z(2), ...
        'comp_i', [1 0 0],'Name', 'Inj_Top', 'Val', rate, 'sign', 1, 'Type', 'rate','Radius', wellRadius); %control by injection pressure
    W(1).components = info.initial;
...
% dt_equil = rampupTimesteps(100*day, 10*day, 5); %rampupTimesteps(45*day, 5*day, 7);
...
if ~opt.shouldPlot
    ...
    fullFinalOut = [fpath, 'WaterInjection_500psi_512NFs.mat'];
