...
% formation
set1 = Field(DFN('dim',3,'n',2,'dir',90,'ddir',0,'minl',5,...
           ...
           'shape','s'),'Poly'); 
set2 = Field(DFN('dim',3,'n',2,'dir',80,'ddir',-1e9,'minl',5,...
            ...
            'shape','s'),'Poly');  
set3 = Field(DFN('dim',3,'n',1,'dir',70,'ddir',-1e9,'minl',5,...
...
case 'ProdTop_InjBot'
    ...
    W = verticalWell(W, G, G.rock, 20, 10, frac_z(2), ...
        'comp_i', [1 0 0],'Name', 'Inj_Top', 'Val', pinj, 'sign', 1, 'Type', 'bhp','Radius', wellRadius); %control by injection pressure
    W(1).components = info.initial;
...
if ~opt.shouldPlot
    ...
    fullFinalOut = [fpath, 'Top_Producer_512NFs.mat'];
