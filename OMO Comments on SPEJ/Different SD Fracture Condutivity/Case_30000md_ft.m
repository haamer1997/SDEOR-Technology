...
wf = 0.03*ft; %100*milli*meter; %SlotFrac aperture (0.328084 ft)
...
G_matrix.rock.perm(fraccells) = 1000*darcy; %5*darcy
...
if ~opt.shouldPlot
    ...
    fullFinalOut = [fpath, 'Case_30000md_ft.mat'];
    save('ws','RF','schedule','-v7.3');
end