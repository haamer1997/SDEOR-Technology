...
set1 = Field(DFN('dim',3,'n',80,'dir',100,'ddir',0,'minl',5,...
           ...
           'shape','s'),'Poly'); 
set2 = Field(DFN('dim',3,'n',80,'dir',45,'ddir',-1e9,'minl',5,...
            ...
            'shape','s'),'Poly');  
set3 = Field(DFN('dim',3,'n',96,'dir',-55,'ddir',-1e9,'minl',5,...
...
if ~opt.shouldPlot
    ...
    fullFinalOut = [fpath, 'HnP_Synthetic_8years_256NFs_nkr_1.7.mat'];
