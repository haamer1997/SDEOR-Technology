...
rng(1234567); 
tol4domain = tol*1e3;
set1 = Field(DFN('dim',3,'n',50,'dir',100,'ddir',-100,'minl',5,...
           ...
           'shape','s'),'Poly'); 
set2 = Field(DFN('dim',3,'n',50,'dir',45,'ddir',-100,'minl',5,...
            ...
            'shape','s'),'Poly');  
set3 = Field(DFN('dim',3,'n',50,'dir',-55,'ddir',-100,'minl',5,...
...
wells(2).points=[heelCooord + tol; EndCoord + tol];
...
pinj = info.pressure + (500*psia); %5,000 psia
...
%% HnP Schedule
time_inj = [25*day 7.5*day 6]; %[25*day 5*day 15] ; [25*day 7.5*day 12]
time_soak = [5*day 2.5*day 3];
time_prod = [70*day 10*day 6]; %SPE-0519-0037-JPT ; [70*day 10*day 12]
totTime = 10*year;%30*year;
