...
set1 = Field(DFN('dim',3,'n',170,'dir',100,'ddir',0,'minl',5,...
           ...
           'shape','s'),'Poly'); 
set2 = Field(DFN('dim',3,'n',170,'dir',45,'ddir',-1e9,'minl',5,...
            ...
            'shape','s'),'Poly');  
set3 = Field(DFN('dim',3,'n',170,'dir',-55,'ddir',-1e9,'minl',5,...
...
casename = 'oil_1';
pwf = 2500*psia; %2000*psia
pinj = 6700*psia;
rate = 0.026216; %10,000 scf/day = 0.003277 m^3/s || 5,000 scf/d = 0.0016385 m^3/s
...
nls.maxIterations = 35; nls.maxTimestepCuts = 10; nls.continueOnFailure = true;
%% HnP Well Definition
W = [];
if (opt.rate)
...
%% HnP Schedule
time_inj = [25*day 7.5*day 12]; %[25*day 5*day 15]
time_soak = [5*day 2.5*day 5];
time_prod = [70*day 10*day 12]; %SPE-0519-0037-JPT
...
if ~opt.shouldPlot
    ...
    fullFinalOut = [fpath, 'HnP_Synthetic_8years_256NFs.mat'];
