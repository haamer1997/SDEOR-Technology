...
set1 = Field(DFN('dim',3,'n',300,'dir',100,'ddir',0,'minl',5,...
           ...
           'shape','s'),'Poly'); 
set2 = Field(DFN('dim',3,'n',300,'dir',45,'ddir',-1e9,'minl',5,...
            ...
            'shape','s'),'Poly');  
set3 = Field(DFN('dim',3,'n',300,'dir',-55,'ddir',-1e9,'minl',5,...
...
nls.maxIterations = 50; nls.maxTimestepCuts = 10; nls.continueOnFailure = true;
disp(linsolve)
%% Schedule
wellRadius = 0.01;
W = [];
...
if ~opt.shouldPlot
    ...
    fullFinalOut = [fpath, 'EOR_1024NF_EOR_60years_SemiCircle.mat']; 
