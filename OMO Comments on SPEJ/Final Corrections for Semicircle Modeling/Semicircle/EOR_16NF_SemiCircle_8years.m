...
set1 = Field(DFN('dim',3,'n',5,'dir',100,'ddir',0,'minl',5,...
           ...
           'shape','s'),'Poly'); 
set2 = Field(DFN('dim',3,'n',5,'dir',45,'ddir',-1e9,'minl',5,...
            ...
            'shape','s'),'Poly');  
set3 = Field(DFN('dim',3,'n',6,'dir',-55,'ddir',-1e9,'minl',5,...
...
useNatural = true;
pargs = {'EdgeColor', 'k', 'FaceAlpha', 0.6, 'edgealpha', 0.05};
figure,
plotCellData(G_matrix,eCIz);
colorbar('horiz'); axis equal tight; view(3);
...
if ~opt.shouldPlot
    ...
    fullFinalOut = [fpath, 'EOR_16NF_SemiCircle_8years.mat'];
