...
%% Converting viscosity units from kg/m.s to cp
...
if ~opt.shouldPlot
    fpath =  'E:/MS Research Work/SD EOR/SD EOR Recovery Mechanisms/Gravity Drainage/';
    fullFinalOut = [fpath, 'EOR_Gravity_1e2_30years.mat'];
