...
set1 = Field(DFN('dim',3,'n',201,'dir',100,'ddir',-100,'minl',5,...
           ...
           'shape','s'),'Poly'); 
set2 = Field(DFN('dim',3,'n',201,'dir',45,'ddir',-100,'minl',5,...
            ...
            'shape','s'),'Poly');  
set3 = Field(DFN('dim',3,'n',112,'dir',-55,'ddir',-100,'minl',5,...
...
% plotWell(G,W); 
dt = rampupTimesteps(totTime, 20*day, nSteps); 
...
if ~opt.shouldPlot
    ...
    fullFinalOut = [fpath, 'EOR_512NF_50microD_Gravity.mat']; 
