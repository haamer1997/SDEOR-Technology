...
% Uncomment to model similar dip and dip direction to Middle Bakken
% formation
% set1 = Field(DFN('dim',3,'n',201,'dir',90,'ddir',0,'minl',5,...
%            'mu',10,'maxl',15,'bbx',[tol4domain,tol4domain,tol4domain,physdim(1)-tol4domain,physdim(2)-tol4domain,physdim(3)-tol4domain],'dip',-40,'ddip',0,...
%            'shape','s'),'Poly'); 
% set2 = Field(DFN('dim',3,'n',201,'dir',80,'ddir',-1e9,'minl',5,...
%             'mu',10,'maxl',15,'bbx',[tol4domain,tol4domain,tol4domain,physdim(1)-tol4domain,physdim(2)-tol4domain,physdim(3)-tol4domain],'dip',-50,'ddip',-1e9,...
%             'shape','s'),'Poly');  
% set3 = Field(DFN('dim',3,'n',112,'dir',70,'ddir',-1e9,'minl',5,...
...
set1 = Field(DFN('dim',3,'n',50,'dir',90,'ddir',0,'minl',15,...
           'mu',30,'maxl',60,'bbx',[tol4domain,tol4domain,tol4domain,physdim(1)-tol4domain,physdim(2)-tol4domain,physdim(3)-tol4domain],'dip',10,'ddip',0,...
           'shape','s'),'Poly'); 
set2 = Field(DFN('dim',3,'n',50,'dir',80,'ddir',-1e9,'minl',15,...
            'mu',30,'maxl',60,'bbx',[tol4domain,tol4domain,tol4domain,physdim(1)-tol4domain,physdim(2)-tol4domain,physdim(3)-tol4domain],'dip',-50,'ddip',-1e9,...
            'shape','s'),'Poly');  
set3 = Field(DFN('dim',3,'n',50,'dir',70,'ddir',-1e9,'minl',15,...
            'mu',30,'maxl',60,'bbx',[tol4domain,tol4domain,tol4domain,physdim(1)-tol4domain,physdim(2)-tol4domain,physdim(3)-tol4domain],'dip',-10,'ddip',-1e9,...
            'shape','s'),'Poly'); %'l','q',4
...
if ~opt.shouldPlot
    ...
    fullFinalOut = [fpath, '512NF_EOR_60years_No_Gravity.mat']; 
