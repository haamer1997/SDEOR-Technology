...
matrix_porosity = gaussianField(G_matrix.cartDims, [0.06 0.1], 3); %gaussianField(G_matrix.cartDims, [0.07 0.9], 3);
matrix_perm = matrix_porosity.^3.*(1e-5)^2./(0.81*72*(1-matrix_porosity).^2)./100;
...
if ~opt.shouldPlot
    ...
    fullFinalOut = [fpath, 'Hetero_Synthatic_Kozeny.mat'];
