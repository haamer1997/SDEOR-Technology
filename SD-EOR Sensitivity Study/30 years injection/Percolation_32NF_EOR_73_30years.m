...
set1 = Field(DFN('dim',3,'n',10,'dir',100,'ddir',0,'minl',5,...
           ...
           'shape','s'),'Poly'); 
set2 = Field(DFN('dim',3,'n',10,'dir',45,'ddir',-1e9,'minl',5,...
            ...
            'shape','s'),'Poly');  
set3 = Field(DFN('dim',3,'n',12,'dir',-55,'ddir',-1e9,'minl',5,...
...
if ~opt.shouldPlot
    ...
    fullFinalOut = [fpath, '32NF_EOR_73_30years.mat']; 
