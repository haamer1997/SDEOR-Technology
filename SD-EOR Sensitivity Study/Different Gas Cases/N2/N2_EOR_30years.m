...
% pwf = 1000*psia;
% pinj = 1600*psia;
casename = 'oil_1_modified'; %'bakken_light';

pwf = 1000*psia; %2500*psia;
pinj = 3000*psia;
rate = 0.006277; %10,000 scf/day = 0.003277 m^3/s
...
info.injection = [0 0 0 1]; %injcet N2
...
if ~opt.shouldPlot
    ...
    fullFinalOut = [fpath, 'Base_EOR_30years.mat'];
