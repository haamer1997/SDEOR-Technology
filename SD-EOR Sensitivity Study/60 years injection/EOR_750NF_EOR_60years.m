...
set1 = Field(DFN('dim',3,'n',305,'dir',100,'ddir',0,'minl',5,...
           ...
           'shape','s'),'Poly'); 
set2 = Field(DFN('dim',3,'n',310,'dir',45,'ddir',-1e9,'minl',5,...
            ...
            'shape','s'),'Poly');  
set3 = Field(DFN('dim',3,'n',150,'dir',-55,'ddir',-1e9,'minl',5,...
...
if ~opt.shouldPlot
    ...
    fullFinalOut = [fpath, 'EOR_750NF_EOR_60years.mat']; 
