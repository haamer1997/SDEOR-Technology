...
% [G_matrix,frac_ids,well_ids]=explicitStencil(physdim, 'aperture',w_f,...
%      'numStages',1,'fracSpacing', 200, 'fracHalfLength'  , x_f,      ...
%      'nxRefine',6,'tipNY',2,'ny',10, 'nz',10, 'gridType','linspacing'); 
...
if useNatural
    model = NatVarsShaleModel(G, G.rock, flowfluid, fluid, 'water', false);
...
s0 = [0.1, 0.9]; %change to a gas phase t
