...
set1 = Field(DFN('dim',3,'n',201,'dir',160,'ddir',0,'minl',5,...
           'mu',10,'maxl',15,'bbx',[tol4domain,tol4domain,tol4domain,physdim(1)-tol4domain,physdim(2)-tol4domain,physdim(3)-tol4domain],'dip',160,'ddip',0,...
           'shape','s'),'Poly'); 
set2 = Field(DFN('dim',3,'n',201,'dir',10,'ddir',-1e9,'minl',5,...
            'mu',10,'maxl',15,'bbx',[tol4domain,tol4domain,tol4domain,physdim(1)-tol4domain,physdim(2)-tol4domain,physdim(3)-tol4domain],'dip',80,'ddip',-1e9,...
            'shape','s'),'Poly');  
set3 = Field(DFN('dim',3,'n',112,'dir',70,'ddir',-1e9,'minl',5,...
            'mu',10,'maxl',15,'bbx',[tol4domain,tol4domain,tol4domain,physdim(1)-tol4domain,physdim(2)-tol4domain,physdim(3)-tol4domain],'dip',10,'ddip',-1e9,...
            'shape','s'),'Poly'); %'l','q',4
...
if ~opt.shouldPlot
    ...
    fullFinalOut = [fpath, '512NF_EOR_73.mat']; 
