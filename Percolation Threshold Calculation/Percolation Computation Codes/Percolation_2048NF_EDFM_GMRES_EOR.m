...
set1 = Field(DFN('dim',3,'n',700,'dir',100,'ddir',0,'minl',5,...
           ...
           'shape','s'),'Poly'); 
set2 = Field(DFN('dim',3,'n',700,'dir',45,'ddir',-1e9,'minl',5,...
            ...
            'shape','s'),'Poly');  
set3 = Field(DFN('dim',3,'n',648,'dir',-55,'ddir',-1e9,'minl',5,...
...
plotWell(G,W); 
dt = rampupTimesteps(totTime, 15*day, nSteps); %20*day
...
if ~opt.shouldPlot
    ...
    fullFinalOut = [fpath, '2048NF_EOR.mat'];
